...
const subjectsList = [
  'ЧОП', 'Химия', 'Математика', 'Физика', 'Информатика',
  'Биология', 'Казак тілі', 'Русский Язык', 'Английский',
  'Казахстан Тарихы', 'Всемирная История', 'Казах литература',
];
...
const Example = () => {
  ...
  const handleLogin = () => {
    const hardcodedPasswords = {
      ...
      'Русский Язык': '456789',
      'Английский': '987123',
      'Казахстан Тарихы': '321789',
      'Всемирная История': '654987',
      'Казах литература': '789321',
    };
    ...
    <div className="w-full p-4 md:max-w-md">
      {loggedInUser ? (
        ...
        <div className="mb-4">
            ...
            <button onClick={handleLogin} className="bg-blue-500 text-white px-3 py-1 rounded-md w-full">
              Логин
            </button>
          </div>
        )}
  <button onClick={saveInfoToFirebase} className="bg-blue-500 text-white px-3 py-1 rounded-md w-full">
          Сохранить информацию
        </button>
        <Tab.Group>
          <div className="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-1 bg-blue-900/20 rounded-xl p-1 text-white-600">
